...
public class AmphibianBus extends Bus {
    private final Bridge bridge;

    public AmphibianBus(@NonNull Context context, int maxCachedEvent) {
        this(context, null, maxCachedEvent);
    }

    public AmphibianBus(@NonNull Context context, String receiverPackageName, int maxCachedEvent) {
